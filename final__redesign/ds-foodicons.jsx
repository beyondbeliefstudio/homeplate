...
// Style: filled shapes, bold, multi-colour, geometric. No strokes except thin details.
// Each renders at any size via `size` prop. ViewBox 0 0 48 48.

const FoodIcon = ({ size = 48, children }) => (
...
// ── Breakfast: fried egg ──────────────────────────────────────────
const FoodBreakfast = ({ size = 48 }) => (
  <FoodIcon size={size}>
    {/* egg white blob — overlapping circles */}
    <g fill="#F5EDD3">
...
// ── Snack: apple ──────────────────────────────────────────────────
const FoodSnack = ({ size = 48 }) => (
  <FoodIcon size={size}>
    {/* apple body — figure-8 top with rounded base */}
...
Object.assign(window, {
  FoodBreakfast, FoodLunch, FoodDinner, FoodSide, FoodSnack, FoodDessert, FoodBeverage,
});
